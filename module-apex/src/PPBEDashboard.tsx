  ...
  return (
    <section style={rootStyle} aria-label="APEX PPBE Performance Dashboard">
      <header style={{ marginBottom: 16 }}>
        <h1 style={titleStyle}>APEX — PPBE Performance</h1>
        <p style={subtitleStyle}>
          Obligation rate, budget-to-actual variance, dependency health, and learning velocity
          (PPBE Phase 5, Execution Monitoring)
        </p>
      </header>
