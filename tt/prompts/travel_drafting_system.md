...
(TravelRequest, TravelPolicy). If D-TT7 resolves to a full-architecture path (Option C)
that changes these fields structurally, this prompt should be reviewed before approval;
otherwise approve as-is alongside the D-TT7 decision, whenever it lands.
Registered agent: tt.travel-drafter (Operational, LLM-backed, extends SCRIBE's
drafting engine). Path: tt/prompts/travel_drafting_system.md
-->

# Travel Drafting System Prompt — `tt.travel-drafter`
