        ...
        const tt = {
          decideTravel: (requestId: string, outcome: TravelDecisionOutcome, note: string): void => {
            try {
              ...
              // All outcomes (APPROVED, DENIED, ESCALATED) remove the item from the
              // workspace surface. ESCALATED transfers responsibility to senior
              // authority — the item is no longer actionable for the current reviewer.
              // NexusApp's publish effect (ROUTED-only filter) confirms reconciliation.
