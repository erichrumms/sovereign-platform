...
| **ARIA/VIGIL banner overclaims enforcement (D4-5)** *(new this version)* | The banner states CUI+ processing "is blocked and logged" — true of the platform's real intake paths, not of these modules' own inputs specifically | Decide: soften the banner's wording, or extend real enforcement to match what it already claims |
