...
- **Status:** Authored Session 5 (June 16, 2026). Approval: **APPROVED — Project Principal, June 16, 2026** (registry of record: `module-counsel/prompts/CHANGELOG.md`, PR-COUNSEL-003; stale header back-propagated July 13, 2026 — the approval itself predates this text correction).
